...
def main():
    ...
    st.sidebar.info("A Simple Python-Streamlit App for Exploring Common ML Datasets")

    st.sidebar.header("About")
    st.sidebar.info("Farhan Ali and Team")
    st.sidebar.text("Maintained by Farhan Ali")
